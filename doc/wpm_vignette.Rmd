...
There are two ways to use the `wpm` package:

* through a [shiny application](#shiny_app) for users who do not necessarily have advanced
...
But you can also try the **demo dataset**, if you want to first understand how to 
manage the app.

Second, you have to specify if there are quotes in your file or not. 
*If you are using the demo dataset, you can skip this section.*
...
We simply do not want to fill them (*e.g.* the corners of the plate), or in 
...
### Step 6: Fixed wells {#fixed_wells}
