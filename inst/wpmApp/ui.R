            ...
            shiny::fluidRow(
              ...
              shiny::column(width = 9,
                shinydashboard::box(width = 12,
                                    ...
                                    shiny::div("WPM is a shiny application (web-based
                                        UI) allowing you to create a plan of
                                        well-plate for your experiments by
                                        controlling batch effects.",br(),br(),
                                        "Indeed, the placement of samples on a
                                        plate can raise questions when we want
                                        to take into account batch effects
                                        (because a placement on a plate is a
                                        technical source of variation),
                                        which may confound the discovery of real
                                        biological variation. The question
                                        therefore arises mainly when the samples
                                        are divided into different groups (here,
                                        we speak of a group to define a category
                                        of the factor to be studied.
                                        Eg: different treatments to compare,
                                        different stages of development, etc.)",
                                        br(),br(),
              ...
              shiny::column(width = 3,
                            shinydashboard::valueBox(value = "0.99.0",
    ...
    shinydashboard::tabItem(tabName = "help",
            shiny::fluidRow(
              shinydashboard::box(width = 12,
                  status = "warning",
                  shiny::h1("Contact"),
                  shiny::div("A vignette is available in the package explaining how to use WPM in detail.",
                      style = "font-size:18px"),
                  shiny::div("Please contact me if you need any help, or if you want to
                    report a bug or if you wish to make comments/suggestions:",
                      style = "font-size:18px"),
                  br(),
                  shiny::column(width = 4,
                                shinydashboard::valueBox(value = "New issue",
                  ...
                  shiny::column(width = 4,
                                shinydashboard::valueBox(value = "Email",
