##' Determines blanks wells coordinates on a plate
##'
##' @description function to place the blanks on the plate according to the
##' selected mode: it generates a dataframe containing the row and column
##' coordinates for each blank.
##'
...
##' @param start_blank character, "even" means that the blanks will be
##' positioned on the even rows of the plate. Otherwise, they will be
##' positioned on the odd rows.
##' @importFrom rlang .data
##' @return a dataframe containing the blank wells with their coordinates.
