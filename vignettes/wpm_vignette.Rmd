...
WPM has 3 main panels: __Home__, __Parameters__ and __Results__.
...
The last sub-step *Choose a Project name* is optional. If you provide one, it 
...
# How to use WPM using command lines
...
The last step is to plot the plate plan(s) using:
```{r visualize plate plan}
...
list containing a dataframe **for each generated plate**. That means, if we 
